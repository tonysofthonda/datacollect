...
public class ModelController {
    ...
    @PostMapping("/update-honda-new-car-retail-formulas")
    public ResponseEntity<?> updateHondaNewCarRetailFormulas(){
        Model response = new ExtendedModelMap();
        try {
            modelService.updateHondaNewCarRetailFormulas();
            response.addAttribute("msg","Formulas updated successfully");
        }catch (Exception e){
            response.addAttribute("msg","Formulas updated successfully");
            return new ResponseEntity<>(response,HttpStatus.INTERNAL_SERVER_ERROR);
        }
