...
public class DcOrderTypeService extends RecordStatusableService<DcOrderType, BigDecimal> implements IDcOrderTypeService {
    ...
    public DcOrderType update(DcOrderType obj, BigDecimal id) {
        DcOrderType currentOrderType = repository.findOne(id);
        if (currentOrderType == null) {
            return null;
        }
        currentOrderType.setCode(obj.getCode());
        currentOrderType.setDescription(obj.getDescription());
        currentOrderType.setDcServicesTypes(obj.getDcServicesTypes());
        return repository.save(currentOrderType);
    }
