...
@Entity
@Table(name = "DC_ACTIVE_FINANCIAL_STATE")
public class DcActiveFinancial implements Serializable {

	private static final long serialVersionUID = 1L;

	
	@Id
    @SequenceGenerator(name = "seq", sequenceName = "dcactivefinancialstate_seq", allocationSize = 1)
