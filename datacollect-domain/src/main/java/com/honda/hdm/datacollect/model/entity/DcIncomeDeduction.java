...
@Entity
@Table(name = "DC_INCOME_DEDUCTION_FINANCIAL_STATE")
public class DcIncomeDeduction implements Serializable {

	private static final long serialVersionUID = 1L;

    @Id
    @SequenceGenerator(name = "seq", sequenceName = "dcincomedeductionfinancialstate_seq", allocationSize = 1)
