...
public interface DcFinancialStateRepository extends IBaseStatusableRepository<DcFinancialState, Long> {
    ...
    @Query("select finState from DcFinancialState finState " +
            ...
            "(:statusId is null or status.id = :statusId) group by finState.id, finState.month, finState.year, finState.limitDate, finState.dealer, finState.dcRecordStatusId, finState.createTimestamp, finState.updateTimestamp")
