...
public interface DcContactXDealerRepository extends IBaseRepository<DcContactXDealer, Long> {
    ...
    @Query(nativeQuery = true,
            value = "select * from dcollectdb.dc_contact_x_dealer contactDealer " +
                    ...
                    "and (position.name_desc like :term or contact.first_name like :term or contact.last_name like :term or contact.mother_last_name like :term or contact.email like :term or contact.phone_number like :term) order by ?#{#pageable}",
